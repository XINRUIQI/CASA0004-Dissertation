...
```bash
python3 code/scripts/figures/make_chapter4_figures.py
python3 code/scripts/figures/make_chapter4_figures.py --only 4.1 4.2
python3 code/scripts/figures/make_chapter4_figures.py --only B.1  # 附录种子稳健性
python3 code/scripts/figures/make_result_figures.py          # 旧附录稳健性图
python3 code/scripts/figures/make_result_figures.py --legacy # 旧 skill / 注意力图
```
