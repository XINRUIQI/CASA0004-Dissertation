...
Run:
  ...
  python3 04_code/scripts/m2/robustness_m2.py --top-n 15   # shap-top15 instead of 20
"""
...
def run_arm(df, dico, arm_label: str, m2_cols: list[str],
    ...
    res_m1r = rolling_fixed(ds_m1, make_ridge_plain, "M1_Ridge", min_train, retrain_every, seed)
    res_m1x = rolling_fixed(ds_m1, make_xgb_plain,  "M1_XGB",   min_train, retrain_every, seed)
    res_m1  = res_m1r.join(res_m1x[[c for c in res_m1x.columns if "M1_XGB" in c]])
