...
Run:
  python3 04_code/scripts/deep/diagnose_rs.py            # Q4/Q2/Q3 (no training)
  python3 04_code/scripts/deep/diagnose_rs.py --gate     # + Q5 (trains one model)
"""
...
def gate_report(epochs: int, lookback: int, seed: int) -> None:
    ...
    n = len(ds["idx"])
    mods, mname, ftype = CONFIGS["m4_deep_gated"]              # fin+rs+ship, gated
