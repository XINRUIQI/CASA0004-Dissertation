...
p-values for the dissertation come from 05_outputs/tests/test_table_main.csv.

    python3 04_code/scripts/tools/fix_deep_legacy_cols.py [--dry-run]
"""
...
DEEP = ROOT / "05_outputs" / "baselines" / "Deep"
