...
```{r flat-deep-slope, echo=FALSE, out.width="90%", fig.cap="Paired slopes from Flat XGBoost to Deep gated fusion at each information set, with S3 highlighted."}
...
```{r shap-modality, echo=FALSE, out.width="100%", fig.cap="Absolute SHAP shares for finance versus shipping over the full sample, annual windows and event windows. Light markers show corresponding modality-gate weights; gate weights and SHAP shares are not directly comparable."}
