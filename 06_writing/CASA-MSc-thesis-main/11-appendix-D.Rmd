...
| 17 June 2026 | **Meeting 3.** Reviewed the first model results. Agreed to add a no-change Model 0 (\(\hat{p}_{t+1}=p_t\)), to compare all models on a common 2019–2026 window with a four-week lag, to document every variable, to simplify remote-sensing features, and to begin a thematic literature review. |
