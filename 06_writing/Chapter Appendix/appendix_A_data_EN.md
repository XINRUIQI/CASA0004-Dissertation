...
thirteen undirected AOI–chokepoint edges of unit weight, specified ex ante and
covering all eleven sites. No chokepoint–chokepoint edges are used. Dynamic
voyage edges are weekly AOI–AOI voyage counts and are defined separately
