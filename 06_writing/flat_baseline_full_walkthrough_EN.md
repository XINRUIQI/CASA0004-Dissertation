...
04_code/
  src/backtest/
    data.py     load matrix, select cols, lag-flatten, fill missing, build target
  ...
  scripts/
    run_baseline.py     single entry point M0–M4
    m1/ m2/ m3/ m4/     per-modality sweep / SHAP / robustness
```
