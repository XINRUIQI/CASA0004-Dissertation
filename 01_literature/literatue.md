...
> **Last updated:** 2026-06-30（编号统一为 P001–P101；P094–P101 = ⑥ 创新/集成层）
>
...
| 状态                     | 数量    | 涉及论文                                                                          |
| ---------------------- | ----- | ----------------------------------------------------------------------------- |
| ✅ 核心/重要/方法             | 89 篇  | P001–P006, P014–P033, P036–P037, P039, P041–P050, P062–P067, P068–P093, P094–P101, P052–P060（去重） |
...
| **合计**                    | **101** | P001–P101 连续编号；按 Tier 1–7 重要性排序（P094–P101 = ⑥ 创新/集成层）         |
...
# 论文阅读优先级清单（按重要性排序，共 101 篇）

> **排序逻辑：** 油价理论基础 → 核心模型与评估方法 → 三模态变量锚点 → 模型架构原始论文 → 模态补充 → 方法参考 → 背景/数据集/备查
>
> **编号说明：** P001–P101 连续编号（P018 = Marini/IMF vessel traffic nowcasting；P061 = GFW SAR 方法 + 数据文档；P094–P101 = ⑥ 创新/集成层）
