...
Thesis source: [`06_writing/CASA-MSc-thesis-main/`](06_writing/CASA-MSc-thesis-main/) · HTML preview: [`docs/index.html`](06_writing/CASA-MSc-thesis-main/docs/index.html)
...
<p align="center">
  <img src="05_outputs/figures/fig_3_1_research_design.png" alt="Research design: three data blocks, four information sets, Flat and Deep pathways, and evaluation against the no-change benchmark." width="100%">
</p>

<p align="center"><em>Figure 3.1. Research design and forecasting workflow.</em></p>
...
Models predict the one-week log return $r_{t+1}=\log(P_{t+1}/P_t)$ and reconstruct the price forecast as $\hat{P}_{t+1\mid t}=P_t\exp(\hat{r}_{t+1\mid t})$. Under this mapping, M0 is exactly a zero-return forecast. RMSE and $\Delta\mathrm{RMSE}$ (percentage RMSE improvement over M0) are computed from reconstructed prices.
...
<p align="center">
  <img src="05_outputs/figures/fig_3_3_study_sites_map.png" alt="World map of 11 oil-infrastructure AOIs and 6 maritime chokepoints." width="90%">
</p>

<p align="center"><em>Figure 3.3. Spatial distribution of the 11 AOIs and 6 chokepoints.</em></p>
