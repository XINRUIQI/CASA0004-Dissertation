...
Outputs (-> results/baselines/Deep/<tier>/):
...
Run:
  python3 code/scripts/deep/run_deep_xattn_viz.py                     # S4
  python3 code/scripts/deep/run_deep_xattn_viz.py --config m3_deep_xattn
"""
