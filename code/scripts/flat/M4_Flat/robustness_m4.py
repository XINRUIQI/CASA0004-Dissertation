...
Outputs (-> results/baselines/Flat/M4_Flat/, or --out-dir):
...
Run:
  ...
  python3 code/scripts/flat/M4_Flat/robustness_m4.py --quick
  python3 code/scripts/flat/M4_Flat/robustness_m4.py --fill-mode fold_median \
...
OUT_DIR  = data.ROOT / "results/baselines/Flat/M4_Flat"
M1_LABEL = "M1_Flat"
