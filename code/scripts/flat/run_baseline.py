...
ONE fair rolling-origin engine (code/src/backtest/) shared by every modality;
...
Outputs (-> results/baselines/Flat/<M*_Flat>/, or --out-dir):
  baseline_metrics[_<suffix>].csv
  baseline_predictions[_<suffix>].csv
  backtest[_<suffix>].png

  M1 example: results/baselines/Flat/M1_Flat/baseline_metrics.csv
  M2 example: results/baselines/Flat/M2_Flat/baseline_metrics_anom.csv
...
Run:
  ...
  python3 code/scripts/flat/run_baseline.py --modality M4 --fill-mode fold_median \
      --out-dir results/experiments/leading_impute/M4_Flat
"""
