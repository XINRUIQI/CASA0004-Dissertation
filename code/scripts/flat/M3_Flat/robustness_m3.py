...
Outputs (-> results/baselines/Flat/M3_Flat/, or --out-dir):
...
Run:
  ...
  python3 code/scripts/flat/M3_Flat/robustness_m3.py --fill-mode fold_median \
      --out-dir results/experiments/leading_impute/M3_Flat
"""
...
def main():
    ...
    for arm in args.arms:
        ...
        print(f"    Ridge={met_m3.loc['M3_Flat_Ridge','RMSE']:.3f}  "
