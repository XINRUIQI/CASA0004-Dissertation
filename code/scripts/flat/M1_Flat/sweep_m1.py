...
Uses the shared kernel (code/src/backtest/) with modality=M1, so the sweep
...
Outputs (-> results/baselines/Flat/M1_Flat/, or --out-dir):
...
Run:
  ...
  python3 code/scripts/flat/M1_Flat/sweep_m1.py --quick   # coarser retrain, faster
  python3 code/scripts/flat/M1_Flat/sweep_m1.py --fill-mode fold_median \
      --out-dir results/experiments/leading_impute/M1_Flat
"""
...
OUT_DIR = data.ROOT / "results/baselines/Flat/M1_Flat"
