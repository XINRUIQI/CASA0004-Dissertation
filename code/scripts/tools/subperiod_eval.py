...
Score arbitrary files:
  python3 code/scripts/tools/subperiod_eval.py \
      --pred results/baselines/Deep/_cross/deep_predictions.csv:Deep_all \
      --pred results/baselines/Flat/M3_Flat/baseline_predictions.csv:M3_Flat \
      --split 2023-01-01
"""
...
OUT_DIR = data.ROOT / "results/baselines/subperiod"
...
DEFAULT_MANIFEST: list[tuple[str, str, "str | None"]] = [
    ("M1_Flat", "results/baselines/Flat/M1_Flat/baseline_predictions.csv", r"^M1_Flat"),
    ("M2_Flat", "results/baselines/Flat/M2_Flat/baseline_predictions_anom.csv", r"^M2_Flat"),
    ("M3_Flat", "results/baselines/Flat/M3_Flat/baseline_predictions.csv", r"^M3_Flat"),
    ("M4_Flat", "results/baselines/Flat/M4_Flat/baseline_predictions_anom.csv", r"^M4_Flat"),
    ("M1_Deep", "results/baselines/Deep/M1_Deep/baseline_predictions.csv", r"^M1_Deep"),
    ("M2_Deep", "results/baselines/Deep/M2_Deep/baseline_predictions.csv", r"(M2_Deep|M_rs_deep)"),
    ("M3_Deep", "results/baselines/Deep/M3_Deep/baseline_predictions.csv", r"(M3_Deep|M_ship)"),
    ("M4_Deep", "results/baselines/Deep/M4_Deep/baseline_predictions.csv", r"^M4_Deep"),
