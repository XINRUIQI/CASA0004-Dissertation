...
Reads committed CSVs / npy under results/ and the weekly feature matrix.
Does not retrain models.

    python code/scripts/figures/make_chapter4_figures.py
    python code/scripts/figures/make_chapter4_figures.py --only 4.1 4.2
