...
Figure 3.5 uses the same geographic frame, markers and colours as Figure 3.3.
    ...
    python code/scripts/figures/make_schematic_figures.py
    python code/scripts/figures/make_schematic_figures.py --only 3.5
    python code/scripts/figures/make_schematic_figures.py --only 3.7
"""
...
EDGE_CSV = (ROOT / "data" / "processed" / "M3" / "outputs"
