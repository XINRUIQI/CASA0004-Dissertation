...
Companion to `03_data/processed/M2/py/eda_m2_mechanism.py`, providing the
...
Outputs (-> 03_data/processed/M3/outputs/):
...
Run:
  python3 03_data/processed/M3/py/eda_m3_mechanism.py
"""
...
OUT = ROOT / "03_data/processed/M3/outputs"
