...
- 脚本 `03_data/processed/M2/py/audit_m2_coverage.py`；产物 `outputs/m2_coverage_report.csv` + 4 张热图（缺失 / 覆盖 / 方差 / 云量）。
...
- 新建 `03_data/processed/M2/py/build_m2_weekly.py`。
...
| **运行** | `python3 03_data/processed/M2/py/audit_m2_coverage.py` 可选 `--start 2017-04 --end 2025-12` 改窗口                                                                                                                 |
