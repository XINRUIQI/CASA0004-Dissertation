...
Reads   03_data/processed/M2/outputs/s2_prithvi_emb_meanpool.npy + _index.csv
Outputs 03_data/processed/M2/outputs/s2_prithvi_emb_check.png + printed report.

Run: python3 03_data/processed/M2/py/verify_s2_embeddings.py
"""
