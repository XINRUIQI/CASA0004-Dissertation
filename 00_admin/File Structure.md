...
│   ├── （现行变量清单已迁至）../flat_baseline_variable_list.md
...
**合并矩阵口径：** 365 周 × 213 列 = `week_ending_friday` + 212 数据列（31+55+113+11 avail+2 target）。详见 `00_admin/flat_baseline_variable_list.md`。
...
| 文档入口 | 进度：`2026-07-15_研究方案与进度总览.md`；变量：`00_admin/flat_baseline_variable_list.md`；逻辑：`项目逻辑与结果总览_CN.md` |
