...
> **Variable list**: `00_admin/flat_baseline_variable_list.md`  
...
**Variable detail**: see `00_admin/flat_baseline_variable_list.md`.
...
05_outputs/baselines/Flat/
  M1_Flat/  baseline_metrics.csv, baseline_predictions.csv, backtest.png, sweep_*
  M2_Flat/  baseline_metrics_anom.csv, shap_*.csv, c2_*, loao_*, sweep_*, watermask
