...
> 对应数据文件：`data/processed/M1/outputs/m1_weekly_features.csv`
> 构建脚本：`data/processed/M1/py/build_m1_weekly.py`
> 最后更新：2026-07-03
...
| 项        | 内容                                                          |
| -------- | ----------------------------------------------------------- |
| 输入根目录    | `data/raw/01_market_financial/`                          |
...
| 输出       | `data/processed/M1/outputs/m1_weekly_features.csv`（唯一产物） |
